...
// main func. Make character obj and assign the right values to the correct label
...
// erase unwanted portion of a string by replacing it with ""
function erase(string, startMarker, endMarker) {
